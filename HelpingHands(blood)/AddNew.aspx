<%@ Page Title="" Language="C#" MasterPageFile="~/bloodbank.Master" AutoEventWireup="true" CodeBehind="AddNew.aspx.cs" Inherits="HelpingHands_blood_.DeleteDonor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-image:url('images/blooddrive.jpg');height:800px;width:1492px; " > 
    <p><center><b>Add New Donor Here ...</b></center><br />
